...
use super::{
    ClaudeCodeApiKeyClient, StreamMessage,
    BILLING_HEADER, CLAUDE_CODE_ENDPOINT, OAUTH_BETA_HEADER,
...
use crate::llms::{
    LlmRequest, StreamEvent, panel_footer_text, panel_header_text, panel_timestamp_text,
...
impl ClaudeCodeApiKeyClient {
    pub(super) fn do_stream(&self, request: LlmRequest, tx: Sender<StreamEvent>) -> Result<(), LlmError> {
        ...
        // Inject context panels as fake tool call/result pairs
